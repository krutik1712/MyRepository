...
__all__ = [
    'STSF_FlagCreate', 'DISPID_SpeechLexiconProns', 'UINT_PTR',
    'SRESoundEnd', 'ISpeechRecoResult2', 'DISPID_SpeechPhraseRules',
    'SRTExtendableParse', 'DISPID_SPAsItem',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SPDKL_DefaultLocation',
    'SVEStartInputStream', 'SWPUnknownWordUnpronounceable',
    'eLEXTYPE_VENDORLEXICON', 'DISPID_SPRsCount', 'SDKLCurrentUser',
    'SPEI_START_INPUT_STREAM', 'SREBookmark', 'ISpRecoGrammar',
    'SpStreamFormatConverter', 'SPXRO_SML', 'DISPID_SPEsItem',
    'SpeechAudioFormatGUIDWave', 'SVSFIsFilename',
    'SPINTERFERENCE_TOOLOUD', 'DISPID_SMSALineId',
    'SpeechGrammarWordType', 'DISPID_SPAPhraseInfo',
    'DISPID_SVSLastBookmark', 'DISPID_SOTCategory', 'DISPID_SRCPause',
    'SPPS_NotOverriden', 'DISPID_SpeechAudioBufferInfo',
    'ISpeechPhraseProperty', 'DISPID_SRGDictationSetState',
    'DISPID_SVEEnginePrivate', 'SpPhoneConverter', 'SPPS_RESERVED1',
    'SPSMF_UPS', 'DISPID_SRGSetTextSelection', 'SPEI_INTERFERENCE',
    'ISpSerializeState', 'SP_VISEME_11',
    'DISPID_SPIEnginePrivateData', 'DISPID_SPIElements',
    'DISPID_SRGetPropertyString', 'SpeechTokenValueCLSID',
    'ISpRecoCategory', 'SVP_10', 'SPFM_CREATE', 'DISPID_SLGetWords',
    'SPSERIALIZEDRESULT', 'DISPID_SRCVoice', 'ISpShortcut',
    'SGRSTTRule', 'SAFT8kHz8BitMono', 'DISPID_SPEAudioStreamOffset',
    'DISPID_SVDisplayUI', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'SPRST_INACTIVE_WITH_PURGE', 'SP_VISEME_7', 'SGLexical',
    'SPPS_LMA', 'DISPID_SFSOpen', 'SpeechCategoryAppLexicons',
    'ISpeechRecognizerStatus', 'IStream', 'SPINTERFERENCE_NOISE',
    'DISPID_SAFType', 'DISPID_SPERetainedSizeBytes',
    'SpeechVisemeFeature', 'SAFT22kHz16BitStereo',
    'DISPID_SVSRunningState', 'DISPID_SGRsCount', 'SITooSlow',
    'SAFTGSM610_8kHzMono', 'DISPID_SVAudioOutput', 'SSTTWildcard',
    'DISPID_SVStatus', 'SpeechLexiconType', 'SVSFParseMask',
    'ISpPhrase', 'ISpeechPhraseProperties', 'SAFT32kHz16BitStereo',
    'DISPID_SASState', 'SVP_11', 'SpeechWordPronounceable',
    'DISPID_SPIAudioStreamPosition', 'SPEI_END_INPUT_STREAM',
    'DISPID_SVEStreamEnd', 'SPLO_STATIC', 'SP_VISEME_8',
    'DISPID_SRCreateRecoContext', 'DISPID_SRGCmdSetRuleState',
    'DISPID_SBSFormat', 'DISPID_SDKGetlongValue',
    'SpeechAddRemoveWord', 'SAFT8kHz16BitStereo',
    'ISpeechAudioBufferInfo', 'SpeechRecoContextState',
    'ISpeechRecoContext', 'DISPID_SWFEAvgBytesPerSec',
    'ISpeechPhraseAlternate', 'SPVPRI_ALERT', 'DISPID_SPRsItem',
    'eLEXTYPE_RESERVED8', 'DISPID_SRGReset', 'ISpPhoneConverter',
    'DISPID_SASCurrentSeekPosition', 'DISPID_SPEPronunciation',
    'DISPID_SGRSAddWordTransition', 'SAFTCCITT_uLaw_11kHzMono',
    'eLEXTYPE_RESERVED10', 'DISPID_SABufferInfo', 'SGRSTTWord',
    'SAFT44kHz16BitStereo', 'SGRSTTTextBuffer',
    'DISPID_SPRules_NewEnum', 'DISPID_SPAsCount', 'SPAS_CLOSED',
    'SPSHT_EMAIL', 'SPEI_RESERVED3', 'DISPID_SpeechRecoResultTimes',
    'SDTDisplayText', 'DISPID_SMSSetData', 'DISPID_SPRFirstElement',
    'DISPID_SPEAudioSizeBytes', 'ISpResourceManager',
    'SPWAVEFORMATTYPE', 'SPGRAMMARSTATE', 'SpeechFormatType',
    'SVP_13', 'SPRST_ACTIVE_ALWAYS', 'SpeechRegistryLocalMachineRoot',
    'DISPID_SLPType', 'DISPID_SRSSupportedLanguages',
    'DISPID_SpeechPhraseBuilder', 'DISPID_SAStatus', 'SVEAllEvents',
    'SPBO_AHEAD', 'SGDSActiveUserDelimited',
    'DISPID_SPIRetainedSizeBytes', 'DISPID_SpeechPhraseReplacement',
    'DISPID_SLGetGenerationChange', 'SLTUser', 'SPEI_SR_BOOKMARK',
    'SpNullPhoneConverter', 'SpeechCategoryRecoProfiles', 'SPPS_Noun',
    'SPEI_VOICE_CHANGE', 'SVF_Stressed', 'DISPID_SpeechFileStream',
    'DISPID_SABIEventBias', 'DISPID_SpeechGrammarRuleState',
    'DISPID_SPPs_NewEnum', 'SpeechRecognizerState',
    'DISPID_SOTDisplayUI', 'ISpeechRecoResultDispatch', 'SVP_8',
    'DISPID_SpeechRecognizerStatus',
    'DISPID_SRSCurrentStreamPosition', 'ISpeechCustomStream',
    'eLEXTYPE_RESERVED9', 'eLEXTYPE_RESERVED4', 'ISpeechMemoryStream',
    'SPAR_Medium', 'ISpeechPhraseAlternates',
    'SAFTTrueSpeech_8kHz1BitMono', 'DISPID_SRCRetainedAudio',
    'SASPause', 'DISPID_SPRDisplayAttributes',
    'ISpeechPhraseElements', 'SRSEDone', 'SP_VISEME_1',
    'SPPS_RESERVED2', 'DISPID_SRSAudioStatus', 'SAFT48kHz16BitMono',
    'DISPID_SRGDictationUnload', 'DISPID_SRGIsPronounceable',
    'SRSInactive', 'SPDATAKEYLOCATION', 'SPXRO_Alternates_SML',
    'DISPID_SRProfile', 'SPSLMA', 'ISpeechPhraseReplacement',
    'DISPID_SGRsFindRule', 'DISPID_SMSAMMHandle', 'SPEI_RESERVED1',
    'SPCS_DISABLED', 'SAFT8kHz8BitStereo', 'DISPID_SGRSRule',
    'SVP_16', 'ISpeechPhraseInfoBuilder', 'DISPID_SRRPhraseInfo',
    'SPSModifier', 'SpObjectTokenCategory', 'eLEXTYPE_PRIVATE3',
    'SGDisplay', 'SAFT11kHz16BitMono', 'DISPID_SPIRule', 'SPCT_SLEEP',
    'DISPID_SOTsItem', 'SINoise', 'DISPID_SpeechPhraseAlternates',
    'DISPID_SOTCEnumerateTokens', 'SPSNotOverriden',
    'SPWORDPRONOUNCEABLE', 'SPEI_RECOGNITION',
    'DISPID_SAFGetWaveFormatEx', 'SAFTCCITT_uLaw_44kHzMono',
    'DISPID_SpeechCustomStream', 'SPFM_CREATE_ALWAYS',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SVSFNLPSpeakPunc',
    'DISPID_SFSClose', 'DISPID_SVEVoiceChange', 'DISPID_SLPsCount',
    'eLEXTYPE_USER', 'DISPID_SGRSTType', 'SECFDefault',
    'DISPID_SGRsCommit', 'SPRULESTATE', 'eLEXTYPE_PRIVATE9',
    'DISPID_SPCPhoneToId', 'ISpeechPhraseRules', 'DISPID_SRCBookmark',
    'DISPID_SVGetAudioInputs', 'DISPID_SOTRemove',
    'DISPID_SpeechObjectTokens', 'SAFTCCITT_uLaw_44kHzStereo',
    'DISPID_SDKCreateKey', 'DISPID_SBSSeek', 'SRARoot',
    'SP_VISEME_18', 'ISpeechGrammarRuleStateTransition',
    'DISPID_SADefaultFormat', 'SRESoundStart',
    'SAFTExtendedAudioFormat', 'DISPID_SPEAudioTimeOffset',
    'DISPID_SpeechLexiconPronunciation', 'SPGRAMMARWORDTYPE',
    'SpeechStreamSeekPositionType', 'DISPID_SRCEAdaptation',
    'DISPID_SLGetPronunciations', 'SSFMOpenReadWrite', 'SP_VISEME_21',
    'SAFTADPCM_44kHzMono', 'SFTInput', 'SPEI_SR_AUDIO_LEVEL',
    'SSFMCreateForWrite', 'DISPID_SRIsUISupported',
    'DISPID_SASNonBlockingIO', 'DISPID_SVRate',
    'SpeechVoiceCategoryTTSRate', 'tagSPPROPERTYINFO', 'SBONone',
    'SpPhraseInfoBuilder', 'DISPID_SRCEPropertyNumberChange',
    'SRSEIsSpeaking', 'DISPID_SRAudioInputStream',
    'SPDKL_CurrentConfig', 'SpeechDictationTopicSpelling',
    'DISPID_SRCEStartStream', 'DISPID_SRCERecognizerStateChange',
    'SVP_4', 'ISpeechRecoResult', 'SpVoice', 'DISPID_SASetState',
    'DISPID_SVSLastBookmarkId', 'IInternetSecurityMgrSite',
    'DISPID_SDKGetStringValue', 'SP_VISEME_5', 'SVP_21',
    'DISPID_SPELexicalForm', 'SPAS_STOP', 'SREAudioLevel', 'SPEVENT',
    'ISpObjectWithToken', 'SpeechTokenKeyUI', 'STCInprocServer',
    'SRCS_Disabled', 'DISPID_SGRInitialState',
    'DISPID_SRRSaveToMemory', 'SVSFParseSapi', 'SPRST_NUM_STATES',
    'ISpStreamFormat', 'SVSFPersistXML', 'DISPID_SVSLastResult',
    'SVSFNLPMask', 'SpMMAudioEnum', 'DISPID_SABIBufferSize',
    'DISPID_SGRSTRule', 'DISPID_SPPsItem', 'SPAUDIOSTATE',
    'ISpeechObjectToken', 'SpeechEngineConfidence',
    ...
    'DISPID_SPRuleFirstElement', 'DISPID_SpeechObjectToken',
    'SITooQuiet', 'DISPID_SGRSAddSpecialTransition', 'SVP_5',
    'DISPID_SOTMatchesAttributes', 'DISPID_SLPPartOfSpeech',
    'DISPID_SGRSTPropertyName', 'SPPS_Modifier',
    'DISPID_SPIReplacements', 'SVF_None', 'DISPID_SGRSTPropertyId',
    'SPSUnknown', 'DISPID_SRGetFormat', 'SAFT32kHz8BitStereo',
    'ISpeechPhoneConverter', 'SECHighConfidence',
    'SPEI_START_SR_STREAM', 'DISPID_SPPEngineConfidence',
    'ISpNotifySink', 'DISPID_SpeechGrammarRules',
    'SPADAPTATIONRELEVANCE', 'DISPID_SRCVoicePurgeEvent',
    'DISPID_SpeechVoiceEvent', 'SPAUDIOBUFFERINFO', 'tagSTATSTG',
    'SREStreamStart', 'SPSHORTCUTPAIRLIST', 'SVP_14',
    'SDTPronunciation', 'DISPID_SpeechAudioFormat',
    'SPWORDPRONUNCIATION', 'LONG_PTR', 'SDA_One_Trailing_Space',
    'DISPID_SDKEnumKeys',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SGRAddResource', 'SBOPause', 'SpInProcRecoContext',
    'SRTEmulated', 'DISPID_SRCESoundStart', 'DISPID_SPCIdToPhone',
    'SGPronounciation', 'SAFTADPCM_22kHzMono', 'SPEI_TTS_PRIVATE',
    'DISPID_SPRNumberOfElements', 'DISPID_SVSpeakCompleteEvent',
    'SASRun', 'ISpeechXMLRecoResult', 'DISPID_SLPSymbolic',
    'DISPID_SRCCreateResultFromMemory', 'SpeechGrammarTagWildcard',
    'DISPID_SRCEEnginePrivate', 'DISPID_SOTDataKey', 'SDTLexicalForm',
    'ISpeechObjectTokenCategory', 'SP_VISEME_16', 'DISPID_SGRId',
    'SPCT_SUB_DICTATION', 'SpFileStream', 'DISPID_SGRSTWeight',
    'DISPID_SPEs_NewEnum', 'SPTEXTSELECTIONINFO', 'SVP_20',
    'ISpRecoContext', 'eLEXTYPE_PRIVATE15', 'SITooLoud',
    'DISPID_SPPNumberOfElements', 'SPEI_FALSE_RECOGNITION',
    'DISPID_SpeechRecoContext', '_ISpeechRecoContextEvents',
    'SpeechTokenContext', 'DISPID_SOTGetAttribute',
    '__MIDL_IWinTypes_0009', 'SAFT16kHz16BitStereo',
    'SpeechRuleAttributes', 'SPBINARYGRAMMAR',
    'DISPID_SPISaveToMemory', 'SpCompressedLexicon',
    'SpUnCompressedLexicon', 'DISPID_SpeechPhraseAlternate',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'DISPID_SLPs_NewEnum',
    'eLEXTYPE_PRIVATE18', 'DISPID_SRCSetAdaptationData',
    'DISPID_SpeechAudio', 'ISpeechGrammarRuleState',
    'DISPID_SOTRemoveStorageFileName', 'SSFMCreate', 'SPLO_DYNAMIC',
    'SpMemoryStream', 'DISPID_SPPConfidence', 'SpeechMicTraining',
    'SVP_9', 'SLODynamic', 'SAFTADPCM_22kHzStereo',
    'SPEI_PROPERTY_STRING_CHANGE', 'Speech_StreamPos_Asap',
    'SAFT24kHz8BitMono', 'DISPID_SRCRetainedAudioFormat',
    'DISPID_SRRSpeakAudio', 'SAFTDefault',
    'DISPID_SASCurrentDevicePosition',
    'DISPID_SpeechGrammarRuleStateTransition', 'SPWORDTYPE',
    'SpeechPropertyResourceUsage', 'SGDSActiveWithAutoPause',
    'DISPID_SRSCurrentStreamNumber', 'SDKLLocalMachine',
    'SAFT24kHz16BitStereo', 'SAFT12kHz16BitStereo',
    'SREPropertyStringChange', 'SP_VISEME_20',
    'SDA_Two_Trailing_Spaces', 'SpStream', 'DISPID_SPRuleId',
    'SREHypothesis', 'SINoSignal', 'SPAO_NONE',
    'SAFTCCITT_ALaw_44kHzMono', 'DISPID_SPCLangId',
    'SpeechAudioFormatGUIDText', 'ISpeechBaseStream',
    'DISPID_SVSpeakStream', 'SPEI_RECO_STATE_CHANGE',
    'SRSInactiveWithPurge', 'eLEXTYPE_PRIVATE7',
    'DISPID_SOTIsUISupported', 'SAFT12kHz8BitMono', 'SPLOADOPTIONS',
    'DISPID_SABufferNotifySize', 'SPEI_MIN_SR', 'SPPHRASEPROPERTY',
    'SRSActive', 'SVSFIsNotXML', 'DISPID_SVEWord',
    'SPWT_PRONUNCIATION', 'SPRULE', 'ISpeechTextSelectionInformation',
    'DISPID_SPPsCount', 'SPWORDLIST', 'DISPID_SRSNumberOfActiveRules',
    'SpeechAudioFormatType', 'eLEXTYPE_PRIVATE13',
    'SWPUnknownWordPronounceable', 'SPFM_NUM_MODES',
    'DISPID_SWFESamplesPerSec', 'SpSharedRecognizer',
    'IEnumSpObjectTokens', 'SPPROPERTYINFO', 'DISPID_SPPId',
    'SPAUDIOOPTIONS', 'DISPID_SRState', 'DISPID_SRCResume',
    'DISPID_SRRTOffsetFromStart', 'SPEI_PHRASE_START',
    'ISpeechRecoGrammar', 'DISPID_SLWsItem',
    'SpeechPropertyResponseSpeed', 'DISPID_SRCEInterference',
    'DISPID_SREmulateRecognition', 'SPDKL_LocalMachine',
    'SPCT_DICTATION', 'SVEViseme', 'SRERequestUI',
    'SAFTCCITT_ALaw_8kHzMono', 'eLEXTYPE_MORPHOLOGY', 'SVP_17',
    'DISPID_SPEDisplayText', 'DISPID_SRGDictationLoad',
    'DISPID_SPEsCount', 'SRATopLevel', 'SPEVENTSOURCEINFO',
    'SP_VISEME_14', 'SAFTGSM610_11kHzMono', 'SSFMOpenForRead',
    'SpeechPropertyComplexResponseSpeed', 'SPPHRASERULE',
    'ISpPhraseAlt', 'DISPID_SLPPhoneIds', 'DISPID_SMSADeviceId',
    'DISPID_SOTsCount', 'SpeechCategoryVoices', 'SASClosed',
    'DISPID_SGRsCommitAndSave',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SPSHORTCUTTYPE',
    'SREPhraseStart', 'SPFM_OPEN_READWRITE', 'DISPID_SPIEngineId',
    'ISpStream', 'SAFT22kHz16BitMono', 'ISpVoice',
    'ISpPhoneticAlphabetSelection', 'SPAO_RETAIN_AUDIO',
    'eLEXTYPE_LETTERTOSOUND', 'ISpeechWaveFormatEx',
    'DISPID_SGRSAddRuleTransition', 'SpObjectToken',
    'SpeechDataKeyLocation', 'SPAR_High', 'SPAS_RUN',
    'DISPID_SVSyncronousSpeakTimeout', 'SECNormalConfidence',
    'ISpLexicon', 'SDTRule', 'SVP_1', 'SpeechPartOfSpeech',
    'ISpeechPhraseReplacements', 'DISPID_SPRuleName', 'SRTAutopause',
    'DISPID_SRRTLength', 'SpeechAudioVolume', 'DISPID_SGRs_NewEnum',
    'DISPID_SVEventInterests', 'SpAudioFormat',
    'SpeechEngineProperties', 'DISPID_SLWPronunciations',
    'SPVPRIORITY', 'DISPID_SVEViseme', 'SGLexicalNoSpecialChars',
    'SVP_6', 'DISPID_SAEventHandle', 'SSSPTRelativeToCurrentPosition',
    'DISPID_SpeechRecoResult', 'DISPID_SPACommit', 'SPEI_RESERVED5',
    'DISPID_SLGenerationId', 'DISPID_SPPParent',
    'SVSFParseAutodetect', '_RemotableHandle', 'SPINTERFERENCE',
    'DISPID_SDKDeleteValue', 'SpeechWordType', 'ISpeechLexicon',
    'DISPID_SRRRecoContext', 'DISPID_SVSLastStreamNumberQueued',
    'ISpeechGrammarRules', 'DISPID_SPRuleEngineConfidence',
    'SpSharedRecoContext', 'DISPID_SRRSetTextFeedback',
    'DISPID_SRGCommit', 'SPEI_MAX_SR', 'DISPID_SPAs_NewEnum',
    'eLEXTYPE_PRIVATE20', 'SPSVerb', 'DISPID_SPEDisplayAttributes',
    'SECFIgnoreWidth', 'SpeechVoiceEvents', 'DISPID_SPIGetText',
    'DISPID_SWFEFormatTag', 'SPEI_SOUND_START', 'SPEI_SOUND_END',
    'SP_VISEME_13', 'SREStreamEnd', 'DISPID_SpeechBaseStream',
    'SPEI_HYPOTHESIS', 'SPCONTEXTSTATE', 'SECFEmulateResult',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SREFalseRecognition',
    'SSSPTRelativeToStart', 'SpeechDisplayAttributes', 'SRAONone',
    'SPEI_MAX_TTS', 'SpShortcut', 'SRAImport', 'DISPID_SLPLangId',
    'ISpAudio', 'WAVEFORMATEX', 'SPEI_END_SR_STREAM',
    'STCLocalServer', 'SAFT12kHz8BitStereo',
    'DISPID_SPRuleNumberOfElements', 'SPPS_RESERVED3',
    'SDKLDefaultLocation', 'SPWT_LEXICAL', 'SP_VISEME_3',
    'DISPID_SVGetVoices', 'Speech_Max_Word_Length', 'SpLexicon',
    'SAFT11kHz8BitStereo', 'SGSExclusive', 'eLEXTYPE_PRIVATE1',
    'eLEXTYPE_PRIVATE17', 'SPEVENTENUM', 'DISPID_SRRGetXMLErrorInfo',
    'STSF_CommonAppData', 'DISPID_SGRClear',
    'SPINTERFERENCE_NOSIGNAL', 'DISPID_SRGetRecognizers',
    'SGRSTTDictation', 'DISPID_SpeechPhraseProperty',
    'ISpeechObjectTokens', 'SPXMLRESULTOPTIONS', 'SVEAudioLevel',
    'DISPID_SVPause', 'SPCS_ENABLED', 'SAFTCCITT_ALaw_11kHzStereo',
    'DISPID_SRCEHypothesis', 'SASStop', 'ISpeechFileStream',
    'ISequentialStream', 'tagSPTEXTSELECTIONINFO', 'SVP_7',
    'SAFTCCITT_ALaw_44kHzStereo', 'SAFTGSM610_22kHzMono',
    'ISpPhoneticAlphabetConverter', 'SREPropertyNumChange',
    'SDTReplacement', 'SP_VISEME_0', 'SSTTTextBuffer',
    'SPPHRASEREPLACEMENT', 'DISPID_SRRAudioFormat',
    'DISPID_SOTCDefault', 'DISPID_SRSetPropertyString',
    'ISpeechResourceLoader', 'SAFT16kHz8BitMono',
    'DISPIDSPTSI_ActiveLength', 'Speech_StreamPos_RealTime',
    'DISPID_SCSBaseStream', 'eLEXTYPE_PRIVATE5', 'SPWORD',
    'SLOStatic', 'SPINTERFERENCE_LATENCY_WARNING', 'SpMMAudioIn',
    'ISpeechRecognizer', 'STCAll', 'SpeechDiscardType',
    'DISPID_SOTGetStorageFileName', 'eLEXTYPE_PRIVATE6',
    'eLEXTYPE_PRIVATE11', 'DISPID_SRCCmdMaxAlternates',
    'SAFTCCITT_uLaw_8kHzStereo', 'DISPID_SVWaitUntilDone',
    'SP_VISEME_6', 'DISPID_SWFEBlockAlign', 'SP_VISEME_2',
    'SpeechTokenKeyAttributes', 'DISPID_SVSCurrentStreamNumber',
    'DISPID_SAFGuid', 'SINone', 'DISPID_SOTCSetId',
    'SpeechRecoEvents', 'DISPID_SLAddPronunciation',
    'ISpeechGrammarRule', 'SPEI_PHONEME', 'SVEBookmark',
    'SPEI_VISEME', 'eWORDTYPE_DELETED', 'SpeechLoadOption',
    'DISPID_SRGCmdLoadFromMemory', 'SPINTERFERENCE_TOOQUIET',
    'STCRemoteServer', 'SGDSActive', 'DISPIDSPTSI_SelectionLength',
    'SECFNoSpecialChars', 'IEnumString', 'SPPS_Unknown', 'SPWF_INPUT',
    'SRAInterpreter', 'DISPID_SVAudioOutputStream',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'DISPID_SLAddPronunciationByPhoneIds', 'DISPID_SRGState',
    'SPINTERFERENCE_TOOSLOW', 'SPINTERFERENCE_NONE',
    'DISPID_SRSetPropertyNumber', 'SAFTADPCM_8kHzStereo',
    'SPBO_TIME_UNITS', 'SFTSREngine', 'DISPID_SRCCreateGrammar',
    'SPEI_UNDEFINED', 'SAFTADPCM_44kHzStereo',
    'DISPID_SPERetainedStreamOffset',
    'DISPID_SpeechObjectTokenCategory', 'DISPID_SGRSTsItem',
    'SVSFPurgeBeforeSpeak', 'SpeechCategoryAudioIn',
    'DISPID_SpeechXMLRecoResult', 'SPAS_PAUSE', 'SPAR_Unknown',
    'SVP_19', 'DISPID_SVSInputWordLength', 'ISpeechVoiceStatus',
    'DISPID_SpeechVoice', 'SpeechTokenKeyFiles',
    'SAFTCCITT_uLaw_11kHzStereo', 'SAFTGSM610_44kHzMono',
    'DISPID_SPRuleConfidence', 'DISPID_SpeechGrammarRule',
    'DISPID_SPPBRestorePhraseFromMemory', 'DISPID_SGRSTs_NewEnum',
    'DISPID_SpeechLexiconWord', 'SGRSTTEpsilon',
    'DISPID_SRCEAudioLevel', 'DISPID_SRRTStreamTime',
    'SDA_No_Trailing_Space', 'ISpMMSysAudio', 'ISpeechAudioStatus',
    'SpWaveFormatEx', 'DISPID_SPRulesItem', 'SpeechAllElements',
    'SPAR_Low', 'DISPID_SpeechPhraseReplacements', 'SP_VISEME_12',
    'SPSTREAMFORMATTYPE', 'ISpeechLexiconWord',
    'ISpeechLexiconPronunciations',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SpeechVisemeType', 'SpPhoneticAlphabetConverter',
    'DISPID_SPEActualConfidence', 'SVP_15', 'DISPID_SOTs_NewEnum',
    'SPRECOCONTEXTSTATUS', 'DISPID_SVEStreamStart',
    ...
    'SREAdaptation', 'SPRECOGNIZERSTATUS', 'SRERecoOtherContext',
    'SPWF_SRENGINE', 'SAFTCCITT_ALaw_22kHzMono',
    'DISPID_SPIProperties', 'DISPID_SpeechRecognizer',
    '_ISpeechVoiceEvents', 'SRTStandard', 'SpeechUserTraining',
    'SPEI_MIN_TTS', 'DISPID_SGRsItem', 'SAFT8kHz16BitMono',
    'DISPID_SPPFirstElement', 'SAFTNonStandardFormat',
    'ISpeechMMSysAudio', 'DISPID_SVEBookmark', 'SVEPhoneme',
    'DISPID_SPRText', 'SAFT44kHz8BitStereo',
    'DISPID_SRRDiscardResultInfo', 'SPAUDIOSTATUS', 'SVPNormal',
    'DISPID_SPARecoResult', 'SpTextSelectionInformation',
    'STSF_AppData', 'ISpRecoContext2', 'ISpeechDataKey',
    'DISPID_SRCERequestUI', 'DISPIDSPRG', 'SPPHRASEELEMENT',
    'ISpeechLexiconPronunciation', 'SPCATEGORYTYPE',
    'DISPID_SPRuleChildren', 'SPPS_Interjection', 'SVEEndInputStream',
    'SpeechPropertyHighConfidenceThreshold', 'DISPID_SVSVisemeId',
    'IInternetSecurityManager', 'SPSEMANTICERRORINFO', 'SPSNoun',
    'DISPID_SpeechPhraseInfo', 'SAFTText',
    'DISPID_SLRemovePronunciation', 'SECLowConfidence',
    'DISPID_SRGRecoContext', 'SAFT48kHz8BitStereo',
    'DISPID_SVIsUISupported', 'SDTAll', 'SAFT44kHz16BitMono',
    'SPEI_RECO_OTHER_CONTEXT', 'SAFT24kHz8BitStereo',
    'SPSERIALIZEDPHRASE', 'DISPID_SGRAddState', 'SREInterference',
    'DISPID_SVGetAudioOutputs', 'DISPID_SAVolume', 'DISPID_SRStatus',
    'SpeechRetainedAudioOptions', 'SPPS_Verb',
    'SAFTADPCM_11kHzStereo', 'SWTAdded', 'DISPID_SGRSTransitions',
    'DISPID_SDKOpenKey', 'DISPID_SRGRules', 'SLTApp',
    'SAFTCCITT_ALaw_11kHzMono', 'SPEI_WORD_BOUNDARY', 'DISPID_SOTId',
    'DISPID_SpeechGrammarRuleStateTransitions', 'DISPID_SPPChildren',
    'Speech_Default_Weight', 'DISPID_SGRSTNextState',
    'DISPID_SRCState', 'SVSFIsXML', 'SRADefaultToActive',
    'SPSMF_SAPI_PROPERTIES', 'SPPHRASE', 'DISPID_SBSWrite',
    'DISPID_SGRSTsCount', 'DISPID_SRCEEndStream', 'SPDKL_CurrentUser',
    'SPEI_REQUEST_UI', 'DISPID_SpeechAudioStatus',
    'DISPID_SPIAudioSizeBytes', 'ISpeechPhraseInfo', 'SVPAlert',
    'SPLEXICONTYPE', 'SPWORDPRONUNCIATIONLIST',
    'DISPID_SPEAudioSizeTime', 'SPRECORESULTTIMES',
    'SpeechRecognitionType', 'SVSFlagsAsync', 'SPEI_RESERVED2',
    'SVP_12', 'DISPID_SPANumberOfElementsInResult', 'SPPS_Function',
    'DISPID_SPRs_NewEnum', 'eLEXTYPE_PRIVATE10', 'SGSEnabled',
    'SPEI_SR_PRIVATE', 'SPINTERFERENCE_TOOFAST', 'DISPID_SVEPhoneme',
    'SPVISEMES', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'SPSHT_OTHER', 'SpeechSpecialTransitionType',
    'DISPID_SRCEFalseRecognition', 'DISPID_SRRTTickCount',
    'SpeechVoicePriority', 'DISPID_SPIStartTime', 'ISpRecoResult',
    'ISpRecoGrammar2', 'SAFTCCITT_uLaw_22kHzMono',
    'DISPID_SpeechPhraseProperties', 'DISPID_SPERequiredConfidence',
    'DISPID_SVESentenceBoundary', 'SPBOOKMARKOPTIONS',
    'DISPID_SpeechDataKey', 'SREStateChange',
    'DISPID_SRCEPropertyStringChange', 'DISPID_SABIMinNotification',
    'SRAORetainAudio', 'SpeechTokenIdUserLexicon', 'DISPID_SRGId',
    'SRTSMLTimeout', 'SVP_18', 'SpeechRegistryUserRoot',
    'SPVOICESTATUS', 'SPPS_SuppressWord', 'SAFTADPCM_8kHzMono',
    'DISPIDSPTSI_ActiveOffset', 'DISPID_SRRTimes',
    'DISPID_SPAStartElementInResult', 'DISPID_SPRulesCount',
    'DISPID_SpeechPhraseElement', 'ISpProperties',
    'SAFTCCITT_uLaw_8kHzMono', 'SAFTCCITT_ALaw_22kHzStereo',
    'Speech_Max_Pron_Length', 'SpeechCategoryAudioOut',
    'DISPID_SVSpeak', 'SDTAlternates', 'SpeechRecoProfileProperties',
    'DISPID_SRCEventInterests', 'DISPID_SRGSetWordSequenceData',
    'ISpeechPhraseRule', 'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'SpMMAudioOut', 'DISPID_SRRAlternates', 'SPSHT_NotOverriden',
    'DISPID_SRGCmdLoadFromObject', 'DISPID_SDKGetBinaryValue',
    'DISPID_SGRName', 'SPRS_ACTIVE', 'SDKLCurrentConfig', 'SVP_3',
    'SVEPrivate', 'DISPID_SRGCmdLoadFromFile', 'SPBO_PAUSE',
    'SPCT_SUB_COMMAND', 'SVF_Emphasis',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'DISPID_SASFreeBufferSpace', 'DISPID_SLPsItem',
    'SAFT32kHz16BitMono', 'SpeechCategoryPhoneConverters',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'ISpEventSource',
    'SAFT24kHz16BitMono', 'SECFIgnoreKanaType',
    'SpeechTokenShellFolder', 'DISPID_SOTCId', 'DISPID_SWFEChannels',
    'SVESentenceBoundary', 'DISPID_SVSkip', 'SAFT16kHz16BitMono',
    'DISPID_SLWLangId', 'SVEWordBoundary', 'DISPID_SRIsShared',
    'DISPID_SGRSTText', 'SVSFDefault', 'DISPID_SLWsCount',
    'SP_VISEME_19', 'SPFILEMODE', 'SpeechVoiceSpeakFlags',
    'DISPIDSPTSI_SelectionOffset', 'SPSHT_Unknown',
    'STSF_LocalAppData', 'eLEXTYPE_RESERVED7', 'ISpeechAudio',
    'SpCustomStream', 'SECFIgnoreCase', 'SDTAudio',
    'SPEI_SR_RETAINEDAUDIO', 'DISPID_SVAlertBoundary',
    'SAFT32kHz8BitMono', 'SVP_2', 'ISpeechPhraseElement',
    'DISPID_SRGetPropertyNumber', 'SPVPRI_NORMAL',
    'SAFT16kHz8BitStereo', 'SPPS_Noncontent', 'DISPID_SMSGetData',
    'SP_VISEME_4', 'SPEI_ADAPTATION', 'SPPARTOFSPEECH',
    'DISPID_SPPValue', 'ISpeechRecoResultTimes',
    'SPEI_TTS_AUDIO_LEVEL', 'DISPID_SpeechLexicon',
    'DISPID_SRRecognizer', 'DISPID_SPPName', 'SPVPRI_OVER',
    'SGDSInactive', 'SpeechGrammarTagDictation',
    'DISPID_SWFEBitsPerSample', 'SAFT48kHz16BitStereo', 'SITooFast',
    'SPBO_NONE', 'DISPID_SRAudioInput', 'SPSEMANTICFORMAT',
    'ISpObjectTokenCategory', 'eLEXTYPE_APP', 'SRTReSent',
    'eLEXTYPE_PRIVATE16', 'ISpNotifyTranslator', 'DISPID_SLWWord',
    'DISPID_SVSPhonemeId', 'SPEI_SENTENCE_BOUNDARY',
    'DISPID_SVGetProfiles', 'SAFTNoAssignedFormat',
    'SpeechGrammarState', 'SPSFunction', 'SVEVoiceChange',
    'SPGS_DISABLED', 'ISpeechVoice', 'eLEXTYPE_PRIVATE4',
    'SSTTDictation', 'SREPrivate',
    'DISPID_SLRemovePronunciationByPhoneIds', 'DISPID_SOTCGetDataKey',
    'DISPID_SRSClsidEngine', 'DISPID_SVVolume',
    'DISPID_SpeechLexiconWords', 'DISPID_SRCESoundEnd',
    'DISPID_SRGCmdLoadFromResource', 'DISPID_SGRAttributes',
    'ISpStreamFormatConverter', 'SP_VISEME_15', 'DISPID_SPRuleParent',
    'ISpXMLRecoResult', 'DISPID_SPIGrammarId',
    'SPEI_PROPERTY_NUM_CHANGE', 'SSSPTRelativeToEnd',
    'DISPID_SRCRequestedUIType', 'DISPID_SpeechRecoContextEvents',
    'SVPOver', 'DISPID_SOTCreateInstance',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SAFTCCITT_uLaw_22kHzStereo',
    'eWORDTYPE_ADDED', 'SDA_Consume_Leading_Spaces',
    'SpeechStreamFileMode', 'DISPID_SBSRead', 'eLEXTYPE_RESERVED6',
    'SRERecognition', 'SPRECOSTATE', 'DISPID_SOTSetId',
    'DISPID_SPEEngineConfidence',
    'SpeechPropertyNormalConfidenceThreshold', 'SGRSTTWildcard',
    'DISPID_SRGCmdSetRuleIdState', 'SPFM_OPEN_READONLY',
    'SpeechVoiceSkipTypeSentence', 'SVSFParseSsml', 'DISPID_SRRAudio',
    'SVSFVoiceMask', 'DISPID_SRRGetXMLResult', 'eLEXTYPE_PRIVATE14',
    'SpeechPropertyLowConfidenceThreshold', 'SAFTADPCM_11kHzMono',
    'eLEXTYPE_PRIVATE12', 'SPSInterjection', 'SRCS_Enabled',
    'SpeechAudioState', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'DISPID_SOTGetDescription', 'SpeechAudioProperties',
    'DISPID_SpeechMMSysAudio', 'DISPID_SPIAudioSizeTime',
    'SWTDeleted', 'DISPID_SRCRecognizer', 'DISPID_SGRsDynamic',
    'SPRST_INACTIVE', 'SPSHORTCUTPAIR',
    'SPEI_ACTIVE_CATEGORY_CHANGED',
    'DISPID_SRCERecognitionForOtherContext', 'SVP_0',
    'DISPID_SVResume', 'eLEXTYPE_PRIVATE8', 'SpeechRunState',
    'DISPID_SRCAudioInInterferenceStatus', 'DISPID_SVVoice',
    'ISpRecognizer2', 'SPEI_RESERVED6', 'DISPID_SVPriority',
    'ISpObjectToken', 'DISPID_SpeechVoiceStatus',
    'ISpeechGrammarRuleStateTransitions',
    'SpeechPropertyAdaptationOn', 'DISPID_SVSInputWordPosition',
    'DISPID_SpeechMemoryStream', 'DISPID_SDKEnumValues',
    'ISpNotifySource', 'SPPS_RESERVED4', 'SRADynamic',
    'eLEXTYPE_USER_SHORTCUT', 'DISPID_SRCEPhraseStart',
    'DISPID_SDKSetLongValue', 'ISpeechAudioFormat',
    'DISPID_SVEAudioLevel', 'SP_VISEME_10', 'ISpGrammarBuilder',
    'ISpEventSink', 'SpeechCategoryRecognizers', 'SRAExport',
    'SAFT22kHz8BitStereo', 'SpResourceManager', 'eLEXTYPE_PRIVATE2',
    'SAFT22kHz8BitMono', 'SpNotifyTranslator',
    'DISPID_SpeechRecoResult2', 'SPRST_ACTIVE', 'SPCT_COMMAND',
    'SpeechEmulationCompareFlags', 'DISPID_SPIGetDisplayAttributes',
    'SVSFUnusedFlags', 'SDTProperty', 'SPRS_ACTIVE_USER_DELIMITED',
    'SP_VISEME_9', 'DISPID_SRDisplayUI',
    'DISPID_SVSInputSentencePosition', 'DISPID_SLWs_NewEnum',
    'DISPID_SpeechPhraseElements', 'DISPID_SRCEBookmark',
    'DISPID_SDKDeleteKey', 'DISPID_SAFSetWaveFormatEx',
    'SREAllEvents', 'SPSSuppressWord', 'SAFT44kHz8BitMono',
    'eLEXTYPE_PRIVATE19', 'ISpDataKey', 'SPGS_EXCLUSIVE',
    'DISPID_SpeechWaveFormatEx', 'DISPID_SVSInputSentenceLength',
    'SAFT12kHz16BitMono', 'DISPID_SpeechPhoneConverter',
    'SPGS_ENABLED', 'SpInprocRecognizer', 'SRSActiveAlways',
    'DISPID_SPILanguageId', 'SP_VISEME_17', 'SPEI_TTS_BOOKMARK',
    'ISpeechLexiconWords', 'SPRS_INACTIVE', 'SPWT_DISPLAY',
    'SGSDisabled', 'ISpRecognizer', 'DISPID_SWFEExtraData',
    'DISPID_SGRSTPropertyValue', 'SpeechRuleState',
    'DISPID_SpeechPhraseRule', 'SAFT48kHz8BitMono', 'DISPID_SGRsAdd',
    'STCInprocHandler', 'DISPIDSPTSI', 'SpeechBookmarkOptions'
]

_check_version('1.2.0', 1697120183.952163)
